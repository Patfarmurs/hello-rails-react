...
>**This app is built using React, Rails, jsbundler, and Webpack, it generate random greeting feetched from the api**.<a name="built-with"></a>
...
```sh
  git clone https://github.com/Patfarmurs/hello-rails-react.git
```
